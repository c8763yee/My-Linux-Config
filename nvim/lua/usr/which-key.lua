...
wk.add({
  ...
  { "<space>a",  group = "misc" },
  { "<space>aa", "<cmd>InsertUUID<cr>",                    desc = "insert UUID" },
  ...
  { "<space>gc", "<cmd>Git commit -v --signoff<cr>",                     desc = "git commit" },
  { "<space>gm", "<cmd>GitMessenger<cr>",                             desc = "show git blame of current line" },
  { "<space>gs", "<cmd> Git status<cr>",                               desc = "git status" },
  { "<space>gp",  group = "git push" },
  { "<space>gpf", "<cmd>Git push --force-with-lease<cr>",            desc = "git push force" },
  { "<space>gpu", "<cmd>Git push<cr>",                                 desc = "git push" },
  { "<space>gl", group = "git pull" },
  { "<space>glr", "<cmd>Git pull --rebase<cr>",                        desc = "git pull rebase" },
  { "<space>glf", "<cmd>Git pull --force<cr>",                         desc = "git pull force" },
  { "<space>gll", "<cmd>Git pull<cr>",                                 desc = "git pull" },
